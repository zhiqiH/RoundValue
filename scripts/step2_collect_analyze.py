"""Step 2: collect trajectories, then immediately run the offline analysis.
...
def main(argv: list[str] | None = None) -> int:
    ...
    def run() -> int:
        ...
        tb._emit(
            {
                "status": "collect_analyze_complete",
                "mode": "collect_analyze",
                "run_id": run_id,
    ...
    return tb.entrypoint("collect_analyze", run, state)
